  ...
  return (
    <div className={styles.commentItem}>
      ...
      <div className={styles.svg}>
        {!isEdit && <svg onClick={() => onClickShow(true)} className={styles.svgItem} xmlns="http://www.w3.org/2000/svg"
        ...
        <svg onClick={onClickRemove} className={styles.svgItem} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
