...
export const FavoriteSVG: FC<ISvgComponentProps> = ({styles}) => {
  return (
    <svg  xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className={cn(styles,"bi bi-heart")}
         viewBox="0 0 16 16" >
      <path
...
export const RemoveFoodSVG: FC<ISvgComponentProps> = ({styles, onClick}) => {
  return (
    <svg onClick={onClick} className={styles} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23 23"
